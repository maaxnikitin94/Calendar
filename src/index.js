...
cur_time.innerText = `${new Date().toLocaleTimeString()}`
...
document.querySelector('.cur__date').onclick = () => {
    cur_month.innerText = `${month_mas[myDate.getMonth()]}`;
    cur_year.innerText = `${String(myDate.getFullYear())}`;
